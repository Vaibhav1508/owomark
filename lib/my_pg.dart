...
class MyPg extends StatefulWidget {
  @override
  _MyPgState createState() => _MyPgState();
}

class _MyPgState extends State<MyPg> {
  ApiInterface apiInterface = new ApiInterface();
  String producturl = 'http://owomark.com/owomarkapp/images/pg/';

  //Category List
  List<PgItem> books = new List();
  @override
  Widget build(BuildContext context) {
    return Expanded(
      child: books.length == 0 ? Center(child: Text('No Pgs Added Yet...',style: TextStyle(fontSize: 16),),) :Container(
  ...
  getBooks(context) async {
    ...
    Future<dynamic> response = apiInterface.getMyPgs(users);
  ...
  removeBooks(context, String id) async {
    ...
    Future<dynamic> response = apiInterface.removeMyPgs(id);
